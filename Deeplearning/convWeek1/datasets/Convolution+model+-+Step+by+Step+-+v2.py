...
#                     print('da_prev_pad',da_prev_pad.shape)
#                     print('W',W.shape)
#                     print('dZ',dZ.shape)
                    da_prev_pad[vert_start:vert_end, horiz_start:horiz_end, :] +=W[:,:,:,c] * dZ[i, h, w, c]
                    dW[:,:,:,c] +=  a_slice * dZ[i, h, w, c]
            ...
            for w in range(n_W):               # loop on the horizontal axis
                for c in range(n_C):           # loop over the channels (depth)
                    ...
                    if mode == "max":
                        ...
                        dA_prev[i, vert_start: vert_end, horiz_start: horiz_end, c] += mask*dA[i, 
                                                                                               vert_start: vert_end,
                        ...
                        dA_prev[i, vert_start: vert_end, horiz_start: horiz_end, c] += distribute_value(dz=da,shape=shape)
